  ...
  return (
    <>
      <div className="flex flex-col text-center w-full  pt-14">
        <h2 className="text-secondary font-bold md:text-4xl text-2xl uppercase relative h-auto w-full pb-1 text-center ">
          Delivering The Most Innovation
          <span className="text-brand"> Goals.</span>
        </h2>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-textColure mt-7 mb-8">
